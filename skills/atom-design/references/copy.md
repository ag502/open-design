...
- *"Type, set with care."* — Atom Specimen — three words; the comma is the design
...
- *"WE ARE A STUDIO. WE ARE NOT A PLATFORM."* — Atom Meridian (test 04) — defines by refusal, all caps
...
- *"NO COMPROMISE."* — Atom Brutal — two words; the period is the design
...
- *"Soft, but exact."* — Atom Plume — two short adjectives, one comma, full stop
...
- *"A salon for the senses."* — Atom Salon — single nominal phrase, comma-free
- *"A page should arrive like a person — composed, deliberate, in good clothes."* — Atom Salon — analogy treats the page as social
- *"With pleasure, you are most welcome."* — Atom Salon salutation — formal address
- *"Restraint, repeated, becomes a signature."* — Atom Atelier — three commas, four words, philosophical
- *"A studied hand."* — three words; the determiner does the work
- *"A small, opinionated craftsmanship engine that argues with your AI assistant on your behalf — and wins."* — Atom Atelier — names the role precisely, embraces the conflict
...
- *"Built to ship."* — Atom Sport — three words, declarative, with a verb that's a verb
- *"Ready? You are two minutes from shipping."* — Atom Sport — a question, then a number
- *"design like print: warm, off-register, intentional."* — Atom Riso — lowercase + colon + three modifiers
...
- *"Hello."* — Atom Quiet salutation — one word; the period is the design
...
- *"A quiet skill."* — Atom Quiet — three words; the article is doing work
- *"Software can be soft and exact at once. That's the trick."* — Atom Plume — names the contradiction, names the resolution
