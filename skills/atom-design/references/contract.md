...
Atom is a *taste* skill. It will not:
...
If a request falls outside taste — "build the auth flow", "wire up Stripe" — do the work, but apply Atom to the rendered surface.
