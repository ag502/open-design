...
| **The Future** | (in repo) | Atom's own body workhorse | Default Atom tone |
...
| Family | Source | Voice | Best for |
| --- | --- | --- | --- |
| **Geist Mono** | Google | Geist's mono companion | Default Atom mono, code, captions |
...
| **Workshop** *(Atom's own theme)* | Free | The Future · Geist · Cabinet Grotesk | The Future · Switzer | The Future Mono · Geist Mono |
...
Pick a ratio. The default for Atom work is **1.25** (major third). Build the scale from a 16px body, then clamp display sizes for responsive.
