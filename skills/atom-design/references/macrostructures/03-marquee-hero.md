...
> *"Type, set with care."* — Atom Specimen — refusal of the verb, treats type as material
> *"A studio for what's next."* — italic editorial display, names the practice without explaining it
> *"Design like print: warm, off-register, intentional."* — Atom Riso — declarative, three modifiers, full stop
