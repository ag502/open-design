// Atom — landing-page interactions.
...
const THEME_GENRES = {
  // editorial — the canonical Atom voice (12 themes)
  specimen:  "editorial",
  newsprint: "editorial",
  atelier:   "editorial",
  garden:    "editorial",
...
const COPY = {
  specimen: {
    ...
    title: HERO_TITLE,
    lede: "Atom is a skill for Claude Code, Cursor, and Codex. It encodes the anti-slop consensus — typography, colour, layout, motion, interaction — into one holistic ruleset your AI assistant will actually follow.",
    ctaLabel: "01 ⁄ Install",
    proofLabel: "Proof",
    ...
    attrib: "The rule Atom is built around",
    salutation: "Dear designer,",
    letterBody: "Every LLM has been trained on the same templates. Without a firm hand, they all emit the same page. Atom is the firm hand. It refuses the defaults, asks the questions that matter, and stamps the page so the next run produces something genuinely different.",
    signoff: "With care,",
    captionA: "Plate 01",
  ...
  newsprint: {
    ...
    title: HERO_TITLE,
    lede: "Twenty-three themes. Twenty-one named page shapes. Forty component archetypes — nine navs, eight footers, four hero polish patterns. A 55-gate slop test that gates every output before it ships. Atom is the rulebook the LLM never read.",
    ...
    attrib: "From the Atom rule sheet",
  ...
  atelier: {
    ...
    letterBody: "We do not believe in defaults. The default is the average; we are looking for the specific. Every page Atom touches is a small refusal of the average, in favour of a page that knows what it is.",
    signoff: "— the studio",
    captionA: "Workbench",
    captionB: "12 April",
  },
  ...
  salon: {
    eyebrow: "A salon",
    title: HERO_TITLE,
    lede: "Atom is composed, not generated. Twelve themes, twenty-one page shapes, thirty-two archetypes, all chosen with intent.",
  ...
  linen: {
    ...
    letterBody: "This is a longer letter than the other themes. It is a deliberate choice. Atom believes that prose-led pages still have a place — that not every product needs a hero, a stat, and a CTA stack. Sometimes, a paragraph is the page.",
  ...
  almanac: {
    ...
    title: HERO_TITLE,
    lede: "A reference book of structural choices, indexed and cross-referenced. Atom looks up the right page-shape for the brief and refuses to use the same one twice.",
    ...
    letterBody: "This page is a reference, not an argument. The numbers are the point: 21 macrostructures, 40 archetypes, 22 themes, 65 slop-test gates. Cross-referenced so the next page Atom builds is genuinely different from the last.",
    signoff: "— editor",
    captionA: "Vol. III",
    captionB: "Plate 12",
  },
  ...
  studio: {
    eyebrow: "Studio · 2026",
    title: HERO_TITLE,
    lede: "We design and build distinctive products for ambitious teams. Atom is our typography opinion, codified — fifteen themes, twenty-one shapes, no defaults.",
    ctaLabel: "Engage",
    ...
    letterBody: "We started this studio because we kept being asked to build the same page, twelve different ways. Atom is our argument: one brief, one shape — chosen, not defaulted to. Take a look.",
    signoff: "Yours,",
