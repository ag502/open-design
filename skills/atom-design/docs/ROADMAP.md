...
> **Preserved attribution.** This is the upstream **Hallmark** roadmap, kept here
> intact for context. Atom-design is currently a brand-swap of Hallmark, so the
> direction described below applies to us too — *until* we deliberately diverge.
> See [`../ATTRIBUTION.md`](../ATTRIBUTION.md). Where this file says "Hallmark",
> assume our work tracks it unless we've forked the relevant area in writing.
