...
> **Preserved attribution.** A 17-slide deck by the upstream Hallmark author.
> Kept here verbatim as a worked example of structuring a long-form narrative
> deck around the anti-AI-slop thesis — useful both as a slide-deck reference
> (see `skills/slides/`) and as a primer on the discipline atom-design enforces.
> Original branding intentionally preserved. See [`../ATTRIBUTION.md`](../ATTRIBUTION.md).
