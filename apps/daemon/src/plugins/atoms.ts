...
export const FIRST_PARTY_ATOMS: ReadonlyArray<AtomCatalogEntry> = [
  ...
  { id: 'visual-validation',       label: 'Visual validation',       description: 'Render the current HTML artifact and compare it with reference screenshots.', status: 'implemented', taskKinds: ['new-generation', 'tune-collab'] },
