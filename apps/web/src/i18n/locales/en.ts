...
export const en: Dict = {
  ...
  'chat.createDesignFromSystemTitle': 'Build with this design system',
  'chat.createDesignFromSystemBody': "Start a new design that inherits this system's colors, type, and components — kept on-brand automatically.",
  'chat.createDesignFromSystemCta': 'Create new design',
