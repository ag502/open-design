...
export const en: Dict = {
  ...
  'modelCapability.value': 'Value',
  'modelCapability.balanced': 'General',
  'modelCapability.reasoning': 'Reasoning',
  'modelCapability.premium': 'Top',
  'modelCapability.coding': 'Code',
  'modelCapability.fastDescription': 'Best for everyday prompts when speed matters.',
  'modelCapability.valueDescription': 'Lower cost for routine work.',
  'modelCapability.balancedDescription': 'Reliable default for most tasks.',
  'modelCapability.reasoningDescription': 'Better for complex logic and planning.',
  'modelCapability.premiumDescription': 'Highest capability, usually higher cost.',
  'modelCapability.codingDescription': 'Tuned for code and technical edits.',
  'modelCost.upToHalf': 'Lowest cost',
  'modelCost.halfToOne': 'Low cost',
