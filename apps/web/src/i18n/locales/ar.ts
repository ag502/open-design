...
export const ar: Dict = {
  ...en,
  'chat.amrErrorGuidance': "هل تريد خدمة نماذج بدون إعداد؟ خدمة AMR الرسمية من Open Design تشغّل وكلاءك عبر بوابة مُدارة.",
  'chat.amrErrorGuidanceCta': "جرّب Open Design AMR",
