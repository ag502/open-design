...
export const tr: Dict = {
  ...
  'chat.createDesignFromSystemTitle': "Bu tasarım sistemiyle oluştur",
  'chat.createDesignFromSystemBody': "Bu sistemin renklerini, tipografisini ve bileşenlerini devralan yeni bir tasarım başlat — otomatik olarak marka uyumlu kalır.",
  'chat.createDesignFromSystemCta': "Yeni tasarım oluştur",
