...
export const ko: Dict = {
  ...
  'chat.createDesignFromSystemTitle': "이 디자인 시스템으로 만들기",
  'chat.createDesignFromSystemBody': "이 시스템의 색상, 타이포그래피, 컴포넌트를 그대로 이어받는 새 디자인을 시작하세요. 항상 브랜드에 맞게 유지됩니다.",
  'chat.createDesignFromSystemCta': "새 디자인 만들기",
