...
export const ru: Dict = {
  ...
  'chat.createDesignFromSystemTitle': "Создавайте на основе этой дизайн-системы",
  'chat.createDesignFromSystemBody': "Начните новый дизайн, который наследует цвета, типографику и компоненты этой системы — всегда автоматически в стиле бренда.",
  'chat.createDesignFromSystemCta': "Создать дизайн",
