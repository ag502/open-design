...
export const zhTW: Dict = {
  ...
  'chat.runError.signInMessage.amr': "Open Design 智慧體尚未登入，前往登入即可正常使用",
  'chat.runError.signInMessage.other': "{agent}尚未登入，請在本機檢查登入狀態。推薦使用 Open Design 智慧體，更穩定划算",
  ...
  'settings.onboardingMemoryCalloutBody': "這些回答會構成你的記憶檔案。Open Design 會在每個任務中重複使用它，並在你工作時持續學習。",
  'settings.onboardingMemoryBenefitIntent': "從一句簡短需求就能理解你的意圖",
  'settings.onboardingMemoryBenefitFewerQuestions': "跳過重複的設定提問",
  'settings.onboardingMemoryBenefitPersonalized': "依你的角色、受眾和品味量身打造產出",
  ...
  'settings.amrActivationBrowserFailed': "無法自動開啟瀏覽器,請開啟下方的登入頁繼續。",
  ...
  'settings.cliEnvHint': "用於覆蓋所選 CLI 的底層環境變數：API key、代理 base URL、自訂 home 或非標準可執行檔路徑。不填 base URL 時，CLI 會使用自己的預設端點。密鑰只保存在本機應用設定中，且只傳給所選 CLI。",
  ...
  'settings.privacyConsentBannerFooter': "預設開啟資料分享。你可以隨時在 設定 → 隱私 中關閉。",
  ...
  'settings.privacyContentHint': "prompt、助手回覆、工具輸入/輸出，以及品質回看所需的完整上下文檔案。傳送前會移除金鑰等敏感資訊。",
  ...
  'homeHero.chip.createBrandKitHint': "從網站擷取一個品牌套件，然後在任意對話中套用它。",
  ...
  'homeHero.chip.prototypeNext': "開啟對話,建構可逐輪打磨的高保真可點擊網頁原型。",
  'homeHero.chip.wireframeNext': "開啟對話,先以低保真畫面與流程驗證結構,再進行視覺設計。",
  ...
  'pluginCard.duplicate': "複製",
  'pluginCard.duplicating': "正在複製…",
  'pluginCard.duplicateFailed': "無法複製這個範本。",
  ...
  'pluginCard.duplicateAria': "將 {title} 複製為新專案",
  ...
  'project.brandReadyRefineHint': "自動擷取可能漏掉細節。大範圍使用前先最佳化這套體系。",
  ...
  'chat.brandBrowserAssistDesktopOnly': "瀏覽器輔助需要桌面應用，Open Design 才能讀取即時瀏覽器頁面。",
  'chat.brandBrowserAssistReadFailed': "無法讀取瀏覽器頁面。請確認品牌網站已開啟並完整載入。",
  'chat.brandBrowserAssistMessage': "Open Design 需要瀏覽器輔助才能完成這次品牌擷取。請先在 Browser 分頁清除頁面攔截，然後在下方確認。",
  ...
  'brandEnrichment.body': "Open Design 會在背景執行更深度的抽取，自動套用合適的設計系統 skills，並就地更新這個系統。通常需要 10-20 分鐘，你可以繼續做其他事。",
  ...
  'brandExtractionTranscript.doneBody': "我已經從 {source} 建立並註冊了 {designSystemId} 設計系統。現在可以預覽，也可以直接用於新設計。",
  'brandExtractionTranscript.next': "接下來，你可以選擇：讓 agent 消耗模型 token 做更深一輪語義化擷取並就地更新設計系統，或用這個已擷取的設計系統建立新設計。",
  ...
  'chat.mode.plan.summary': "先產生可編輯的規劃文件，等你確認和修改後，再交給 Design 產生最終成果。",
  'chat.mode.plan.solves': "適合 PRD、PPT 大綱、原型需求、線框圖、分鏡腳本，以及任何需要先確認方向的大需求。",
  ...
  'chat.designToolbox.action.asset-search.description': "为当前设计搜索可用图片、参考截图、moodboard 和素材来源候选。",
  'chat.designToolbox.action.icon-workflow.title': "找 icon / 替换 icon",
  'chat.designToolbox.action.icon-workflow.badge': "图标",
  'chat.designToolbox.action.icon-workflow.description': "查找、生成或替换图标、SVG、Lucide icon 和视觉符号，并保持风格一致。",
  'chat.designToolbox.action.image-replace.title': "替换页面图片",
  'chat.designToolbox.action.image-replace.badge': "换图",
  'chat.designToolbox.action.image-replace.description': "审查当前配图，把薄弱的 hero、分区、背景或卡片图片替换成更合适的素材。",
  'chat.designToolbox.action.reference-extract.title': "参考图获取 / 风格提取",
  'chat.designToolbox.action.reference-extract.badge': "参考",
  'chat.designToolbox.action.reference-extract.description': "分析参考截图或网站，提取配色、字体、布局姿态、动效和素材方向。",
  ...
  'chat.designToolbox.action.transition-motion.description': "设计页面、场景、加载和状态切换过场，并补上克制节奏和 reduced-motion 兜底。",
  'chat.designToolbox.action.threejs-scene.title': "3D / Three.js 场景",
  'chat.designToolbox.action.threejs-scene.badge': "3D",
  'chat.designToolbox.action.threejs-scene.description': "加入或规划 Three.js、Spline、Vanta、粒子、WebGL、地图或 deck.gl 风格交互视觉。",
  ...
  'chat.designToolbox.action.chart-gen.description': "生成 ECharts、React Flow、图解、数据看板、关系图或数据可视化素材。",
  'chat.designToolbox.action.logo-gen.title': "logo / 品牌标识生成",
  'chat.designToolbox.action.logo-gen.badge': "Logo",
  'chat.designToolbox.action.logo-gen.description': "为当前品牌创建 logo 路线、字标、组合标、符号和身份系统生成 prompt。",
  'chat.designToolbox.action.plan-outline.title': "基於想法產生 PPT 大綱",
  'chat.designToolbox.action.plan-outline.badge': "規劃",
  'chat.designToolbox.action.plan-outline.description': "先把粗略想法變成可編輯的 Markdown PPT 大綱，再建立投影片。",
  ...
  'chat.designToolbox.prompt.autoMatchStep3': "3. 如果目标或审美标准还不够清楚，用结构化 question-form 引导我选择，给出推荐默认项，并确保每个有限选项问题都有可编辑的自定义填写入口；如果已经足够清楚，直接执行下一步。",
  'chat.designToolbox.prompt.autoMatchStep4': "4. 按“诊断 -> 风格方向 -> 资源选择 -> 具体改动/生成 -> 验证”的顺序走完全程。每一步说明为什么选这些资源，以及下一步需要我确认什么。",
  'chat.designToolbox.prompt.assetSearch': "为当前设计寻找最合适的图片/参考素材。搜索现有文件、connectors、MCP、浏览器截图和生成工具，给出具体候选、使用方式、必要的授权/来源提醒；如果没有可用素材，给出可执行的生图 prompt。",
  'chat.designToolbox.prompt.iconWorkflow': "优化当前设计的 icon 系统：找出缺失图标，替换薄弱图标，保持描边/填充/圆角/线宽一致；优先使用现有图标库，库里没有合适图标时再生成 SVG/icon prompt。",
  'chat.designToolbox.prompt.imageReplace': "审查当前设计里的每个图片位，找出占位感或质量弱的配图，然后替换或指定更好的 hero、分区、背景、卡片和社媒图。保持布局不乱，并给出明确文件/prompt/来源选择。",
  'chat.designToolbox.prompt.referenceExtract': "把当前参考图/参考网站/design file 当作视觉输入，提取配色、字号阶梯、布局节奏、组件姿态、动效线索和素材风格，再应用到当前设计；不要逐字复制受保护的品牌资产。",
  'chat.designToolbox.prompt.motion': "请基于当前 HTML / 页面元素加入高质量动效：入场、滚动、状态切换、过场、Rive/Lottie 风格图标动效或 GSAP/Motion 微交互任选最有效的 1-2 处。保持克制，优先 transform / opacity，并加 prefers-reduced-motion 兜底。",
  'chat.designToolbox.prompt.planOutline': "基于这个想法创建或更新一份 Markdown PPT/Deck 规划文档。暂时不要生成最终 PPT。请包含逐页标题、页面目标、内容要点、视觉方向、所需数据/素材和开放问题。把它保存为 Design Files 里的 `.md` 文件，并告诉我需要 review 哪个文件。",
  'chat.designToolbox.prompt.motionPolish': "请审查并润色现有动效的节奏、缓动、性能和可访问性。修掉突兀、廉价或影响阅读的动画；必要时改成更细腻的时间线。",
  'chat.designToolbox.prompt.transitionMotion': "为当前设计规划高质量过场动画：页面/场景切换、加载承接、状态变化和分区衔接。需要时使用 GSAP/Motion/CSS，保持性能和克制节奏，并提供 reduced-motion 行为。",
  'chat.designToolbox.prompt.threejsScene': "为当前设计规划或实现一个聚焦的 Three.js/WebGL 视觉。可考虑 Three.js、Spline 风格场景、Vanta 背景、粒子系统、Mapbox/deck.gl 数据层或浏览器 Portal 效果，但必须有用并验证可渲染。",
  ...
  'chat.designToolbox.prompt.chartGen': "为当前设计生成最合适的图表、图解或数据可视化。根据数据和用户目标，在 ECharts、React Flow、SVG/CSS 图解、雷达图、关系图、看板或 deck.gl/地图可视化之间选择。",
  'chat.designToolbox.prompt.logoGen': "为当前品牌创建 logo 和身份方向。输出多条字标、符号、组合标、配色、使用规则和生成 prompt 路线；确保结果原创，并能落到当前 artifact 里。",
  ...
  'chat.designToolbox.prompt.processRule': "流程规则：先定义审美目标和约束，再搜索/匹配资源；需要用户选择时生成结构化 question-form，并为有限选项保留可编辑的自定义答案，确认后继续执行。",
  ...
  'preview.usePluginOnly': "僅使用外掛",
  'preview.usePluginOnlyDesc': "套用外掛結構,內容自己寫",
  'preview.replicateContent': "複刻此內容",
  'preview.replicateContentDesc': "使用範例提示詞,產生與預覽相同的內容",
  'preview.duplicateTemplate': "複製",
  'preview.duplicateTemplateDesc': "將目前範例複製成可編輯的新專案",
  ...
  'designFiles.documentTemplate.goalBody': "說明希望 Open Design 基於這份文件生成、修改或判斷什麼。",
  'designFiles.documentTemplate.capabilitiesHeading': "如何使用這份文件",
  'designFiles.documentTemplate.capabilityMarkdown': "可以自由使用 Markdown：標題、表格、清單、連結、引用、程式碼區塊和圖片。",
  'designFiles.documentTemplate.capabilityAgent': "Open Design agent 可以讀取、編輯這份檔案，並把它作為專案上下文。",
  'designFiles.documentTemplate.capabilityImages': "可以貼上圖片，或把圖片拖到編輯器裡；上傳後的圖片會插入到目前游標位置。",
  'designFiles.documentTemplate.scenarioHeading': "場景說明",
  'designFiles.documentTemplate.scenario.prototype': "做原型時，寫清楚產品目標、目標使用者、流程、頁面、模組、互動狀態、響應式斷點，以及顏色、字體、間距、圓角、動效等 design tokens。",
  'designFiles.documentTemplate.scenario.wireframe': "做線框圖時，描述使用者流程、頁面清單、版面層級、內容區塊、低保真約束，以及視覺設計前需要驗證的問題。",
  'designFiles.documentTemplate.scenario.mobile': "做行動應用時，列出目標平台、頁面、導覽模型、手勢、原生模式、裝置尺寸、狀態和行動端 design tokens。",
  'designFiles.documentTemplate.scenario.slideDeck': "做簡報時，寫成分頁 PPT 大綱：每頁包含標題、目的、核心訊息、證據、視覺方向、講稿備註和匯出要求。",
  'designFiles.documentTemplate.scenario.document': "做文件時，定義受眾、語氣、章節結構、資料來源、引用或數據、版式預期和 PDF/匯出要求。",
  'designFiles.documentTemplate.scenario.image': "做圖片時，說明主體、比例、構圖、視覺風格、品牌 tokens、參考檔案和負向約束。",
  'designFiles.documentTemplate.scenario.video': "做影片時，寫出分鏡：場景、時長、字幕、動效、素材、音訊備註和輸出格式。",
  'designFiles.documentTemplate.scenario.hyperframes': "做 HyperFrames 時，描述 HTML 動態內容：場景、時間軸、字幕、音訊響應點、轉場和錄製/匯出要求。",
  'designFiles.documentTemplate.scenario.audio': "做音訊時，定義人聲或音樂方向、時長、情緒、腳本或文案、節奏、發音備註和最終用途。",
  'designFiles.documentTemplate.scenario.liveArtifact': "做即時看板時，說明資料來源、刷新頻率、元件、篩選、互動、空/載入/錯誤狀態，以及提醒或自動化要求。",
  'designFiles.documentTemplate.scenario.designSystem': "做設計系統時，列出品牌目標、tokens、字體、顏色、間距、元件、素材、參考和需要遵守/避免的規則。",
  'designFiles.documentTemplate.scenario.default': "描述受眾、交付物、必要內容、參考、約束，以及什麼狀態算完成。",
  'designFiles.documentTemplate.nextHeading': "下一步",
  'designFiles.documentTemplate.nextBody': "檢查並編輯這份文件，然後讓 Open Design 基於它生成、修改或執行操作。",
  ...
  'designFiles.usefulInfoTip14': "滿意的專案可透過「分享」選單儲存為範本，下次直接複用。",
  ...
  'fileViewer.exportPptxScreenshotHint': "每頁一張圖,像素級 100% 還原,但不可編輯。",
  ...
  'nextStep.planGenerateBody': "以已確認的 Markdown 規劃文件為依據產生下一版產物。",
  'nextStep.planImproveTitle': "繼續優化文件",
  'nextStep.planImproveBody': "先把目前規劃文件補完整，再進入最終生成。",
  'nextStep.planGeneratePrompt': "以 `{file}` 作為唯一事實來源。先讀取這份文件，保留其中已經確定的決策，然後產生與文件匹配的最終設計產物。如果它是逐頁大綱，就產生 PPT/Deck；如果它是 PRD 或原型規劃，就產生原型或線框圖；如果它是分鏡或創意 brief，就產生對應的視覺/媒體產物。產生前請指出你無法自行解決的阻塞 TODO 或矛盾點。",
  'nextStep.planImprovePrompt': "讀取 `{file}`，並直接在原文件中優化這份可編輯規劃文件。收緊範圍，補齊薄弱章節，增加驗收標準；仍需要使用者輸入的地方保留 TODO / open question。暫時不要產生最終設計產物。",
  'nextStep.planImproveArtifactTitle': "繼續優化產物",
  'nextStep.planImproveArtifactBody': "基於目前產物繼續打磨，而不是回到規劃階段。",
  'nextStep.planImproveArtifactPrompt': "直接優化 `{artifact}`。保留目前已經可用的產物和行為，優先改進產品結構、視覺層級、互動細節和內容表達。完成後總結改動檔案和仍需注意的風險。",
  'nextStep.planMergeTitle': "融合文件與產物",
  'nextStep.planMergeBody': "把規劃意圖和已生成產物對齊，讓兩者一起推進。",
  'nextStep.planMergePrompt': "同時讀取 `{document}` 和 `{artifact}`。把文件視為意圖來源，把產物視為目前實作，然後融合兩者：讓產物對齊已確認決策，只在文件過時時更新文件，仍未確定的內容保留 TODO / open question。保留目前已可用的行為，最後總結文件和產物分別改了什麼。",
  ...
  'artifact.odCardBrandAssistBody': "在瀏覽器中開啟品牌網站，讓 Open Design 繼續擷取此設計體系。",
  ...
  'settings.memoryProfileHint': "關於你和你預設偏好的幾項資訊。記憶會在每次任務前注入這些內容，讓代理人能從簡短的需求推斷你的意圖。",
  'settings.memoryProfileName': "工作檔案",
  'settings.memoryProfileDescription': "角色、公司、領域、受眾、品味，以及助理應重複使用的預設偏好。",
  ...
  'settings.memoryProfileAestheticPlaceholder': "e.g. 簡潔有編輯感、淺色背景、充裕的留白",
  'settings.memoryProfileDeliverables': "預設交付物",
  'settings.memoryProfileDeliverablesPlaceholder': "e.g. 著陸頁、簡報、一頁式文件",
  ...
  'settings.memoryProfileGoalsPlaceholder': "e.g. 推出新的定價頁、提升試用流程的轉換率",
  'settings.memoryHooksTitle': "記憶掛鉤",
  'settings.memoryHooksHint': "選擇要自動執行的記憶環節。上方的總開關會將全部關閉。",
  ...
  'settings.memoryHooksVerifyDesc': "POST：依照你的規則檢查結果，然後顯示評分卡。",
  ...
  'dsManager.deleteConfirm': "刪除「{title}」？這會從本裝置移除該草稿設計體系。",
  ...
  'brand.librarySubtitle': "把你的品牌套件教給 Open Design——從網站擷取一個品牌套件，然後在任意對話中套用它。",
  ...
  'newBrand.title': "新增品牌",
  'newBrand.subtitle': "貼上一個網站，或在下方挑選一個品牌，我們會擷取它的顏色、字型和標誌。",
  ...
  'onboarding.brandSubtitle': "貼上品牌網站，我們會把品牌線索轉成後續可重用的設計系統。",
  'onboarding.brandSkip': "暫時略過",
  'onboarding.brandDone': "設計系統已擷取",
  'onboarding.buildTitle': "一次建立,處處沿用",
  'onboarding.buildBody': "Open Design 將你的品牌沉澱為可重用的設計系統,讓你之後打造的一切都保持品牌一致。",
  'onboarding.buildBenefitMemoryTitle': "一份品牌記憶",
  'onboarding.buildBenefitMemoryBody': "色彩、字體、間距、元件和語氣會沉澱成可重用的 DESIGN.md。",
  'onboarding.buildBenefitAlignedTitle': "每個產出都保持一致",
  'onboarding.buildBenefitAlignedBody': "原型、簡報、PDF、儀表板和行銷素材都會使用同一套規則。",
  'onboarding.buildBenefitSourcesTitle': "從既有素材開始",
  'onboarding.buildBenefitSourcesBody': "可以使用 GitHub repo、網站、既有 DESIGN.md、截圖、字體或 Figma 檔案。",
  ...
  'dsCreate.missingSourceError': "請加入網站、DESIGN.md、描述、檔案、Figma 來源或備註來建立設計系統。",
  ...
  'dsCreate.sourceSectionBody': "從 GitHub repo、網站、DESIGN.md 或能體現風格的檔案開始。Open Design 會先快速建立一套可用系統，之後 AI 可在專案中繼續細化。",
  'dsCreate.githubWebsiteLabel': "GitHub 或網站",
  'dsCreate.add': "加入",
  'dsCreate.startFromBrand': "從品牌開始",
  'dsCreate.brandPickerSubtitle': "搜尋數百個品牌，選一個後我們會把它的網站加入為風格參考。",
  ...
  'dsCreate.describeBrandHelp': "品牌語氣、簡介和產品脈絡。會用於快速生成和 AI 細化。",
  'dsCreate.companyPlaceholder': "例如：Mission Impastabowl，一間支援自助點餐、行動 app 和網站的快休閒義大利麵餐廳",
  'dsCreate.pasteDesignMd': "貼上 DESIGN.md",
  'dsCreate.pasteDesignMdHelp': "貼上 DESIGN.md，即可直接從 token、設計理由和元件指南建立設計系統。",
  ...
  'dsCreate.uploadFigHelper': "在你的裝置上解碼成真實 token、元件和素材，無需 Figma 帳號。",
  ...
  'dsCreate.savedFigmaHelp': "已儲存為 Figma 設計來源。Agent 會把它作為標準參考；若需完整離線解碼，請在上方匯出 .fig。",
  'dsCreate.notes': "備註",
  'dsCreate.notesPlaceholder': "例如：我們使用溫暖自然的配色和圓角。品牌語氣有趣但專業...",
  'dsCreate.back': "返回",
  ...
  'dsCreate.designMdGeneratedDescription': "由貼上的 DESIGN.md token、設計理由和元件指南生成。",
  ...
  'ds.deleteProjectConfirm': "刪除「{title}」？這會從本裝置永久移除該設計體系及其專案。",
  ...
  'ds.reviewFeedbackPlaceholder': "例如：收緊 {title} 的間距，重新產生這個預覽...",
  'ds.reviewChangedAfterFeedback': "此段落已依照你的回饋變更。發布前請再次審閱。",
  ...
  'ds.publishCardDraft': "你的設計體系已準備好，但回饋可以繼續改進它。準備好用於後續專案時再發布。",
  'ds.useSystemTitle': "使用此體系",
  'ds.useSystemBody': "新建設計會繼承此體系的顏色、字體和元件，並自動保持品牌一致。",
  ...
  'ds.generationSourceDetail': "公司背景、GitHub 儲存庫、本機程式碼資料夾、Figma 檔案、字體、Logo 和備註。",
  ...
  'ds.sectionRunningReadingContext': "Open Design 正在讀取 {title} 的段落上下文。",
  ...
  'ds.repoConnectBannerBody': "連接 GitHub 後，Open Design 可以讀取你的儲存庫，並把顏色、字體和元件擷取到此設計體系中。",
