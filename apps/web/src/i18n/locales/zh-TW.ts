...
export const zhTW: Dict = {
  ...
  "modelCapability.fast": "快速",
  "modelCapability.value": "省錢",
  "modelCapability.balanced": "通用",
  "modelCapability.reasoning": "推理",
  "modelCapability.premium": "最強",
  "modelCapability.coding": "程式碼",
  "modelCapability.fastDescription": "適合日常生成，回應更快",
  "modelCapability.valueDescription": "適合常規任務，成本更低",
  "modelCapability.balancedDescription": "多數任務的穩妥預設選擇",
  "modelCapability.reasoningDescription": "適合複雜邏輯與規劃",
  "modelCapability.premiumDescription": "能力最強，通常成本更高",
  "modelCapability.codingDescription": "適合程式碼生成與技術修改",
  "modelCost.upToHalf": "最低成本",
  "modelCost.halfToOne": "低成本",
