...
export const zhTW: Dict = {
  ...
  'chat.createDesignFromSystemTitle': "基於此設計系統創作",
  'chat.createDesignFromSystemBody': "新建一個設計，自動沿用該系統的色彩、字型和元件，並始終保持品牌一致。",
  'chat.createDesignFromSystemCta': "新建設計",
  ...
  'brandDetail.openFullSystem': '開啟完整系統',
