...
export const zhTW: Dict = {
  ...
  'teamProjects.count': '{count} 個專案',
  'teamProjects.personalCount': '{count} 個個人專案',
  'teamProjects.sharedCount': '{count} 個已共享',
  'teamProjects.refresh': '重新整理',
  'teamProjects.loadFailed': '無法載入工作區專案。',
  'teamProjects.moveFailed': '無法更新專案可見性。',
  'teamProjects.loading': '正在載入專案...',
  'teamProjects.emptyDrafts': '暫無草稿。',
  'teamProjects.emptyAll': '暫無工作區專案。',
  'teamProjects.visibilityTeam': '團隊',
  'teamProjects.visibilityPersonal': '個人',
  'teamProjects.sharedBadge': '已共享',
  'teamProjects.openProject': '開啟',
  'teamProjects.moveToTeam': '共享到團隊',
  'teamProjects.moveToPersonal': '移回草稿',
  'teamProjects.syncLocalOnly': '僅本機',
  'teamProjects.syncPending': '等待同步',
  'teamProjects.syncSynced': '已同步',
  'teamProjects.syncFailed': '同步失敗',
  'teamProjects.syncRemoteDeleted': '雲端已移除',
  "entry.cloudCalloutTitle": "登入雲端",
  "entry.cloudCalloutBody": "登入後即可解鎖團隊協作、共享專案與工作區管理。",
