...
export const fa: Dict = {
  ...
  'chat.createDesignFromSystemTitle': "با این سیستم طراحی بسازید",
  'chat.createDesignFromSystemBody': "یک طراحی تازه را آغاز کنید که رنگ‌ها، تایپوگرافی و اجزای این سیستم را به ارث می‌برد — و به‌طور خودکار هماهنگ با برند می‌ماند.",
  'chat.createDesignFromSystemCta': "ایجاد طراحی جدید",
