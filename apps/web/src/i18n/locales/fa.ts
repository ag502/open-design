...
export const fa: Dict = {
  ...
  'modelCapability.fast': 'سریع',
  'modelCapability.value': 'ارزش',
  'modelCapability.balanced': 'عمومی',
  'modelCapability.reasoning': 'استدلال',
  'modelCapability.premium': 'برتر',
  'modelCapability.coding': 'کد',
  'modelCapability.fastDescription': 'برای درخواست‌های روزمره وقتی سرعت مهم است.',
  'modelCapability.valueDescription': 'هزینه کمتر برای کارهای معمول.',
  'modelCapability.balancedDescription': 'گزینه پیش‌فرض مطمئن برای بیشتر کارها.',
  'modelCapability.reasoningDescription': 'بهتر برای منطق پیچیده و برنامه‌ریزی.',
  'modelCapability.premiumDescription': 'بالاترین توان، معمولا با هزینه بیشتر.',
  'modelCapability.codingDescription': 'تنظیم‌شده برای کد و ویرایش‌های فنی.',
  'modelCost.upToHalf': 'کمترین هزینه',
  'modelCost.halfToOne': 'هزینه کم',
