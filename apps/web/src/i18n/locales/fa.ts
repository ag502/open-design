...
export const fa: Dict = {
  ...
  'pluginCard.duplicate': 'تکثیر',
  'pluginCard.duplicating': 'در حال تکثیر…',
  'pluginCard.duplicateFailed': 'امکان تکثیر این قالب وجود نداشت.',
  ...
  'pluginCard.duplicateAria': 'تکثیر {title} به‌عنوان پروژه جدید',
  ...
  'preview.duplicateTemplate': 'تکثیر',
  'preview.duplicateTemplateDesc': 'این نمونه را در یک پروژه قابل ویرایش جدید کپی کنید',
