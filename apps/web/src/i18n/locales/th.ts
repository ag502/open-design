...
export const th: Dict = {
  ...
  'chat.createDesignFromSystemTitle': "สร้างด้วยดีไซน์ซิสเต็มนี้",
  'chat.createDesignFromSystemBody': "เริ่มงานออกแบบใหม่ที่สืบทอดสี ตัวอักษร และคอมโพเนนต์ของระบบนี้ — คงความสอดคล้องกับแบรนด์โดยอัตโนมัติ",
  'chat.createDesignFromSystemCta': "สร้างงานออกแบบใหม่",
