...
export const zhCN: Dict = {
  ...
  'chat.runError.signInMessage.amr': "Open Design 智能体尚未登录，前往登录即可正常使用",
  'chat.runError.signInMessage.other': "{agent}尚未登录，请本地检查登录状态。推荐使用 Open Design 智能体，更稳定划算",
  ...
  'settings.onboardingMemoryCalloutBody': "这些回答会构成你的记忆画像。Open Design 会在每个任务中复用它，并在你工作时持续学习。",
  'settings.onboardingMemoryBenefitIntent': "从一句简短需求就能理解你的意图",
  'settings.onboardingMemoryBenefitFewerQuestions': "跳过重复的设置提问",
  'settings.onboardingMemoryBenefitPersonalized': "按你的角色、受众和品味定制产出",
  ...
  'settings.amrActivationBrowserFailed': "没能自动打开浏览器,请打开下面的登录页继续。",
  ...
  'settings.privacyConsentBannerFooter': "默认开启数据分享。你可以随时在 设置 → 隐私 中关闭。",
  ...
  'settings.privacyContentHint': "prompt、助手回复、工具输入/输出，以及质量回看所需的完整上下文文件。发送前会剥离密钥等敏感信息。",
  ...
  'homeHero.chip.createBrandKitHint': "从网站提取一个设计系统，然后在任意对话中应用它。",
  ...
  'homeHero.chip.prototypeNext': "打开对话,构建可逐轮打磨的高保真可点击网页原型。",
  'homeHero.chip.wireframeNext': "打开对话,先用低保真屏幕与流程验证结构,再做视觉设计。",
  ...
  'pluginCard.duplicate': "复制",
  'pluginCard.duplicating': "正在复制…",
  'pluginCard.duplicateFailed': "无法复制这个模板。",
  ...
  'pluginCard.duplicateAria': "将 {title} 复制为新项目",
  ...
  'project.brandReadyRefineHint': "自动提取可能漏掉细节。大范围使用前先优化这套体系。",
  ...
  'chat.brandBrowserAssistDesktopOnly': "浏览器辅助需要桌面应用，Open Design 才能读取实时浏览器页面。",
  'chat.brandBrowserAssistReadFailed': "无法读取浏览器页面。请确认品牌网站已打开并完全加载。",
  'chat.brandBrowserAssistMessage': "Open Design 需要浏览器辅助才能完成这次品牌提取。请先在 Browser 标签页清除页面拦截，然后在下方确认。",
  ...
  'brandEnrichment.body': "Open Design 会在后台运行更深度的抽取，自动带上合适的设计系统 skills，并原地更新这个系统。通常需要 10-20 分钟，你可以继续做别的事。",
  ...
  'brandExtractionTranscript.doneBody': "我已经从 {source} 创建并注册了 {designSystemId} 设计系统。现在可以预览，也可以直接用于新设计。",
  'brandExtractionTranscript.next': "接下来，你可以选择：让 agent 消耗模型 token 做更深一轮语义化抽取并原地更新设计系统，或用这个已抽取的设计系统新建设计。",
  ...
  'chat.mode.plan.summary': "先生成可编辑的规划文档，等你确认和修改后，再交给 Design 生成最终产物。",
  'chat.mode.plan.solves': "适合 PRD、PPT 大纲、原型需求、线框图、分镜脚本，以及任何需要先确认方向的大需求。",
  ...
  'chat.designToolbox.action.plan-outline.description': "先把粗略想法变成可编辑的 Markdown PPT 大纲，再创建幻灯片。",
  ...
  'preview.usePluginOnly': "仅使用插件",
  'preview.usePluginOnlyDesc': "套用插件结构,内容自己写",
  'preview.replicateContent': "复刻此内容",
  'preview.replicateContentDesc': "使用示例提示词,生成与预览相同的内容",
  'preview.duplicateTemplate': "复制",
  'preview.duplicateTemplateDesc': "把当前示例复制成一个可编辑的新项目",
  ...
  'designFiles.documentTemplate.goalBody': "说明希望 Open Design 基于这份文档生成、修改或判断什么。",
  'designFiles.documentTemplate.capabilitiesHeading': "如何使用这份文档",
  'designFiles.documentTemplate.capabilityMarkdown': "可以自由使用 Markdown：标题、表格、清单、链接、引用、代码块和图片。",
  'designFiles.documentTemplate.capabilityAgent': "Open Design agent 可以读取、编辑这份文件，并把它作为项目上下文。",
  'designFiles.documentTemplate.capabilityImages': "可以粘贴图片，或把图片拖到编辑器里；上传后的图片会插入到当前光标位置。",
  'designFiles.documentTemplate.scenarioHeading': "场景说明",
  'designFiles.documentTemplate.scenario.prototype': "做原型时，写清楚产品目标、目标用户、流程、页面、模块、交互状态、响应式断点，以及颜色、字体、间距、圆角、动效等 design tokens。",
  'designFiles.documentTemplate.scenario.wireframe': "做线框图时，描述用户流程、页面清单、布局层级、内容区块、低保真约束，以及视觉设计前需要验证的问题。",
  'designFiles.documentTemplate.scenario.mobile': "做移动应用时，列出目标平台、页面、导航模型、手势、原生模式、设备尺寸、状态和移动端 design tokens。",
  'designFiles.documentTemplate.scenario.slideDeck': "做幻灯片时，写成分页 PPT 大纲：每页包含标题、目的、核心信息、证据、视觉方向、讲稿备注和导出要求。",
  'designFiles.documentTemplate.scenario.document': "做文档时，定义受众、语气、章节结构、资料来源、引用或数据、版式预期和 PDF/导出要求。",
  'designFiles.documentTemplate.scenario.image': "做图片时，说明主体、比例、构图、视觉风格、品牌 tokens、参考文件和负向约束。",
  'designFiles.documentTemplate.scenario.video': "做视频时，写出分镜：场景、时长、字幕、动效、素材、音频备注和输出格式。",
  'designFiles.documentTemplate.scenario.hyperframes': "做 HyperFrames 时，描述 HTML 动态内容：场景、时间线、字幕、音频响应点、转场和录制/导出要求。",
  'designFiles.documentTemplate.scenario.audio': "做音频时，定义人声或音乐方向、时长、情绪、脚本或文案、节奏、发音备注和最终用途。",
  'designFiles.documentTemplate.scenario.liveArtifact': "做实时看板时，说明数据源、刷新频率、组件、筛选、交互、空/加载/错误状态，以及提醒或自动化要求。",
  'designFiles.documentTemplate.scenario.designSystem': "做设计系统时，列出品牌目标、tokens、字体、颜色、间距、组件、素材、参考和需要遵守/避免的规则。",
  'designFiles.documentTemplate.scenario.default': "描述受众、交付物、必需内容、参考、约束，以及什么状态算完成。",
  'designFiles.documentTemplate.nextHeading': "下一步",
  'designFiles.documentTemplate.nextBody': "检查并编辑这份文档，然后让 Open Design 基于它生成、修改或执行操作。",
  ...
  'designFiles.usefulInfoTip14': "满意的项目可通过「分享」菜单保存为模板，下次直接复用。",
  ...
  'fileViewer.exportPptxScreenshotHint': "每页一张图,像素级 100% 还原,但不可编辑。",
  ...
  'nextStep.planGenerateBody': "以已确认的 Markdown 规划文档为依据生成下一版产物。",
  'nextStep.planImproveTitle': "继续优化文档",
  'nextStep.planImproveBody': "先把当前规划文档补完整，再进入最终生成。",
  'nextStep.planGeneratePrompt': "以 `{file}` 作为唯一事实来源。先读取这份文档，保留其中已经确定的决策，然后生成与文档匹配的最终设计产物。如果它是逐页大纲，就生成 PPT/Deck；如果它是 PRD 或原型规划，就生成原型或线框图；如果它是分镜或创意 brief，就生成对应的视觉/媒体产物。生成前请指出你无法自行解决的阻塞 TODO 或矛盾点。",
  'nextStep.planImprovePrompt': "读取 `{file}`，并直接在原文件中优化这份可编辑规划文档。收紧范围，补齐薄弱章节，增加验收标准；仍需要用户输入的地方保留 TODO / open question。暂时不要生成最终设计产物。",
  'nextStep.planImproveArtifactTitle': "继续优化产物",
  'nextStep.planImproveArtifactBody': "基于当前产物继续打磨，而不是回到规划阶段。",
  'nextStep.planImproveArtifactPrompt': "直接优化 `{artifact}`。保留当前已经可用的产物和行为，优先改进产品结构、视觉层级、交互细节和内容表达。完成后总结改动文件和仍需注意的风险。",
  'nextStep.planMergeTitle': "融合文档与产物",
  'nextStep.planMergeBody': "把规划意图和已生成产物对齐，让两者一起推进。",
  'nextStep.planMergePrompt': "同时读取 `{document}` 和 `{artifact}`。把文档视为意图来源，把产物视为当前实现，然后融合两者：让产物对齐已确认决策，只在文档过时时更新文档，仍未确定的内容保留 TODO / open question。保留当前已可用的行为，最后总结文档和产物分别改了什么。",
  ...
  'artifact.odCardBrandAssistBody': "在浏览器中打开品牌网站，让 Open Design 继续提取此设计体系。",
  ...
  'settings.memoryProfileHint': "关于你和你默认偏好的几条事实。记忆会在每次任务前注入这些信息，让智能体从一句简短的描述中推断出你的意图。",
  'settings.memoryProfileName': "工作画像",
  'settings.memoryProfileDescription': "助手应复用的角色、公司、领域、受众、品味与默认偏好。",
  ...
  'settings.memoryProfileDomainPlaceholder': "例如：B2B SaaS、fintech、devtools",
  ...
  'settings.memoryProfileAestheticPlaceholder': "例如：简洁有编辑感、浅色背景、充裕留白",
  'settings.memoryProfileDeliverables': "默认交付物",
  'settings.memoryProfileDeliverablesPlaceholder': "例如：落地页、幻灯片、单页文档",
  'settings.memoryProfileLocale': "地区 / 语言",
  'settings.memoryProfileLocalePlaceholder': "例如：English (US)、Simplified Chinese",
  'settings.memoryProfileGoals': "当前目标",
  'settings.memoryProfileGoalsPlaceholder': "例如：上线新的定价页、提升试用流程的转化率",
  'settings.memoryHooksTitle': "记忆钩子",
  'settings.memoryHooksHint': "选择记忆的哪些部分自动运行。上方的总开关可以一次性关闭全部。",
  ...
  'settings.memoryHooksVerifyDesc': "POST：依据你的规则核对结果，然后展示评分卡。",
  ...
  'dsManager.deleteConfirm': "删除「{title}」？这会从本设备移除该草稿设计体系。",
  ...
  'brand.librarySubtitle': "把你的设计系统教给 Open Design——从网站提取一个设计系统，然后在任意对话中应用它。",
  ...
  'newBrand.subtitle': "粘贴一个网站，或在下方挑选一个品牌，我们会提取它的颜色、字体和标识。",
  ...
  'onboarding.brandSubtitle': "粘贴品牌网站，我们会把品牌线索转成后续可复用的设计系统。",
  'onboarding.brandSkip': "暂时跳过",
  'onboarding.brandDone': "设计系统已提取",
  'onboarding.buildTitle': "一次创建,处处复用",
  'onboarding.buildBody': "Open Design 把你的品牌沉淀为可复用的设计系统,让你之后构建的一切都保持品牌一致。",
  'onboarding.buildBenefitMemoryTitle': "一份品牌记忆",
  'onboarding.buildBenefitMemoryBody': "颜色、字体、间距、组件和语气会沉淀成可复用的 DESIGN.md。",
  'onboarding.buildBenefitAlignedTitle': "每个产出都保持一致",
  'onboarding.buildBenefitAlignedBody': "原型、幻灯片、PDF、看板和营销物料都会使用同一套规则。",
  'onboarding.buildBenefitSourcesTitle': "从已有材料开始",
  'onboarding.buildBenefitSourcesBody': "可以使用 GitHub 仓库、网站、现有 DESIGN.md、截图、字体或 Figma 文件。",
  ...
  'dsCreate.sourceSectionBody': "从 GitHub 仓库、网站、DESIGN.md 或能体现风格的文件开始。Open Design 会先快速创建一套可用系统，然后 AI 可在项目中继续细化。",
  'dsCreate.githubWebsiteLabel': "GitHub 或网站",
  'dsCreate.add': "添加",
  'dsCreate.startFromBrand': "从品牌开始",
  'dsCreate.brandPickerSubtitle': "搜索数百个品牌，选择一个后我们会把它的网站作为风格参考加入。",
  ...
  'dsCreate.describeBrandHelp': "品牌语气、简介和产品上下文。会用于快速生成和 AI 细化。",
  'dsCreate.companyPlaceholder': "例如：Mission Impastabowl，一个支持自助点餐、移动应用和网站的快休闲意面餐厅",
  'dsCreate.pasteDesignMd': "粘贴 DESIGN.md",
  'dsCreate.pasteDesignMdHelp': "粘贴 DESIGN.md，即可直接从 token、设计理由和组件指南创建设计系统。",
  ...
  'dsCreate.uploadFigHelper': "在你的设备上解码为真实 token、组件和素材，无需 Figma 账号。",
  ...
  'dsCreate.savedFigmaHelp': "已保存为 Figma 设计来源。Agent 会把它作为标准参考；如需完整离线解码，请在上方导出 .fig。",
  'dsCreate.notes': "备注",
  'dsCreate.notesPlaceholder': "例如：我们使用温暖自然的配色和圆角。品牌语气有趣但专业...",
  'dsCreate.back': "返回",
  ...
  'dsCreate.designMdGeneratedDescription': "由粘贴的 DESIGN.md token、设计理由和组件指南生成。",
  ...
  'ds.deleteProjectConfirm': "删除「{title}」？这会从本设备永久移除该设计体系及其项目。",
  ...
  'ds.reviewFeedbackPlaceholder': "例如：收紧 {title} 的间距，重新生成这个预览...",
  'ds.reviewChangedAfterFeedback': "此段落已根据你的反馈发生变化。发布前请再次审阅。",
  ...
  'ds.publishCardDraft': "你的设计体系已准备好，但反馈可以继续改进它。准备好用于后续项目时再发布。",
  'ds.useSystemTitle': "使用此体系",
  'ds.useSystemBody': "新建设计会继承此体系的颜色、字体和组件，并自动保持品牌一致。",
  ...
  'ds.generationSourceDetail': "公司背景、GitHub 仓库、本地代码文件夹、Figma 文件、字体、Logo 和备注。",
  ...
  'ds.sectionRunningReadingContext': "Open Design 正在读取 {title} 的段落上下文。",
  ...
  'ds.repoConnectBannerBody': "连接 GitHub 后，Open Design 可以读取你的仓库，并把颜色、字体和组件提取到此设计体系中。",
