...
export const zhCN: Dict = {
  ...
  "modelCapability.value": "省钱",
  "modelCapability.balanced": "通用",
  "modelCapability.reasoning": "推理",
  "modelCapability.premium": "最强",
  "modelCapability.coding": "代码",
  "modelCapability.fastDescription": "适合日常生成，响应更快",
  "modelCapability.valueDescription": "适合常规任务，成本更低",
  "modelCapability.balancedDescription": "多数任务的稳妥默认选择",
  "modelCapability.reasoningDescription": "适合复杂逻辑与规划",
  "modelCapability.premiumDescription": "能力最强，通常成本更高",
  "modelCapability.codingDescription": "适合代码生成与技术修改",
