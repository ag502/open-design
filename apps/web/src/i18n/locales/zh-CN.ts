...
export const zhCN: Dict = {
  ...
  'chat.amrCard.switchBody': '可切换到 Open Design，无需配置 API Key。完成登录、授权和充值后，将自动重试当前任务。',
  'chat.amrCard.chipOfficial': '官方托管',
  'chat.amrCard.chipNoKey': '无需 API Key',
  'chat.amrCard.chipAutoRetry': '授权后自动重试',
  'chat.amrCard.switchCta': '切换到 Open Design 并重试',
  'chat.amrError.authMessage': 'Open Design 账号尚未授权。完成授权后将自动重试当前任务。',
  'chat.amrError.balanceMessage': 'Open Design 账户余额不足。充值后可继续运行当前任务。',
  ...
  'settings.onboardingAmrCloudAuthorizeAction': '授权',
  ...
  'settings.onboardingGateTooltipAmr': '后续流程由 AI 运行，请先登录 Open Design。',
  ...
  'entry.youtubeLabel': '在 YouTube 上观看 Open Design',
  ...
  'handoff.amrWebsite': '打开 Open Design 官网',
  ...
  'designFiles.usefulInfoTip16': '在 Threads 上关注 @opendesign.ai，看团队幕后动态。',
  'designFiles.usefulInfoTip17': '在 Instagram 上关注 @opendesign.ai，获取设计灵感。',
  'designFiles.usefulInfoTip18': '在 YouTube 上订阅 Open Design，观看教程和演示。',
  'designFiles.usefulInfoTip19': '在 LinkedIn 上关注 Open Design，了解产品动态。',
  'designFiles.usefulInfoTip20': '在小红书上关注 Open Design，获取技巧和灵感。',
