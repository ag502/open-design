...
export const zhCN: Dict = {
  ...
  'brand.libraryTitle': '品牌',
  'brand.librarySubtitle': '把你的品牌教给 Open Design——从网站提取一个品牌，然后在任意对话中应用它。',
  'brand.newBrand': '新建品牌',
  'brand.searchPlaceholder': '搜索你的品牌…',
  'brand.empty': '还没有品牌。从一个网站提取一个品牌即可开始。',
  ...
  'newBrand.extract': '提取品牌',
  'newBrand.cancel': '取消',
  'newBrand.close': '关闭',
  'newBrand.stage1': '正在抓取网站并测量其设计',
  'newBrand.stage2': '正在构建品牌预览',
  'newBrand.stage3': '正在推导并注册设计体系',
  ...
  'brandDetail.delete': '删除品牌',
  'brandDetail.back': '品牌',
  'brandDetail.refining': '正在优化此品牌…',
  'brandDetail.notFound': '未找到品牌。',
