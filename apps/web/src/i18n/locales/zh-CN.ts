...
export const zhCN: Dict = {
  ...
  'teamProjects.count': '{count} 个项目',
  'teamProjects.personalCount': '{count} 个个人项目',
  'teamProjects.sharedCount': '{count} 个已共享',
  'teamProjects.refresh': '刷新',
  'teamProjects.loadFailed': '无法加载工作区项目。',
  'teamProjects.moveFailed': '无法更新项目可见性。',
  'teamProjects.loading': '正在加载项目...',
  'teamProjects.emptyDrafts': '暂无草稿。',
  'teamProjects.emptyAll': '暂无工作区项目。',
  'teamProjects.visibilityTeam': '团队',
  'teamProjects.visibilityPersonal': '个人',
  'teamProjects.sharedBadge': '已共享',
  'teamProjects.openProject': '打开',
  'teamProjects.moveToTeam': '共享到团队',
  'teamProjects.moveToPersonal': '移回草稿',
  'teamProjects.syncLocalOnly': '仅本地',
  'teamProjects.syncPending': '等待同步',
  'teamProjects.syncSynced': '已同步',
  'teamProjects.syncFailed': '同步失败',
  'teamProjects.syncRemoteDeleted': '云端已移除',
  "entry.cloudCalloutTitle": "登录云端",
  "entry.cloudCalloutBody": "登录后即可解锁团队协作、共享项目与工作区管理。",
  ...
  "workspace.readonlyNotice": "共享项目只读：你可以查看和评论，但不能编辑项目文件或通过 Chat 修改 Artifact。",
