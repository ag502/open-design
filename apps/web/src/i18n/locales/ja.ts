...
export const ja: Dict = {
  ...
  'chat.createDesignFromSystemTitle': "このデザインシステムで作成",
  'chat.createDesignFromSystemBody': "このシステムのカラー・タイポグラフィ・コンポーネントを引き継いだ新しいデザインを作成します。常にブランドに沿った状態を保ちます。",
  'chat.createDesignFromSystemCta': "新しいデザインを作成",
