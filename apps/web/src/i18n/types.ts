...
export interface Dict {
  ...
  'teamProjects.count': string;
  'teamProjects.personalCount': string;
  'teamProjects.sharedCount': string;
  'teamProjects.refresh': string;
  'teamProjects.loadFailed': string;
  'teamProjects.moveFailed': string;
  'teamProjects.loading': string;
  'teamProjects.emptyDrafts': string;
  'teamProjects.emptyAll': string;
  'teamProjects.visibilityTeam': string;
  'teamProjects.visibilityPersonal': string;
  'teamProjects.sharedBadge': string;
  'teamProjects.openProject': string;
  'teamProjects.moveToTeam': string;
  'teamProjects.moveToPersonal': string;
  'teamProjects.syncLocalOnly': string;
  'teamProjects.syncPending': string;
  'teamProjects.syncSynced': string;
  'teamProjects.syncFailed': string;
  'teamProjects.syncRemoteDeleted': string;
