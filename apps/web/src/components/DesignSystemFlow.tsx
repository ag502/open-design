...
function buildSourceContextManifest(
  ...
  sections.push(
    ...
    '- README.md should include a source-backed Product Overview/Product Context section, source repository or source folder references, package contents, preview file manifest, and reuse workflow, similar to Claude Design exports.',
